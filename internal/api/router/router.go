...
func New(deps Dependencies) *gin.Engine {
	...
	v1 := engine.Group("/v1")
	{
		...
		v1.GET("/events", deps.AuthMiddleware.Handle(), deps.AdminMiddleware.Handle(), deps.EventLogHandler.List)
		v1.GET("/events/verify", deps.AuthMiddleware.Handle(), deps.AdminMiddleware.Handle(), deps.EventLogHandler.VerifyResource)
		v1.GET("/events/:eventId/verify", deps.AuthMiddleware.Handle(), deps.AdminMiddleware.Handle(), deps.EventLogHandler.VerifyEvent)
		...
		v1.GET("/me/capabilities", deps.AuthMiddleware.Handle(), deps.ShopHandler.Capabilities)
